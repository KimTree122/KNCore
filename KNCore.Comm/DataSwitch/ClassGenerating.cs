...
namespace KNCore.Comm.DataSwitch
{
    ...
    {
        //根据匿名类生成实体类，根据datatable生成实体类,根据sql生成实体类
        ...
        {
            string connstr = ConfigExtensions.Configuration["UploadFile:DirectoryRootPath"]; ;
